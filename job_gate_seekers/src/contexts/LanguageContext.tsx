...
const en: Dict = {
    ...
    sessionLimitReached: "You reached the maximum of 3 chat sessions.",
    sessionLimitHint: "No new sessions can be created. Contact support if you need a reset.",
    messageLimitReached: "This session reached 20 messages. Sending is disabled.",
    messageLimitCounter: "Messages used",
    market: "Market",
    ...
    authFailed: "Failed",
    resetLinkSent: "If the email exists, a reset code has been sent.",
    ...
    next: "Next",
    step: "Step",
    registerStep1Title: "Profile basics",
    registerStep2Title: "Email OTP verification",
    registerStep3Title: "Password setup",
    preferredLanguage: "Preferred language",
    englishLanguage: "English",
    arabicLanguage: "Arabic",
    sendRegistrationOtp: "Send OTP",
    resendRegistrationOtp: "Resend OTP",
    resendIn: "Resend in",
    otpCode: "OTP code",
    otpHint: "Enter the 6-digit code we sent to your email.",
    ...
    verifyEmailOtpFirst: "Please verify your email OTP first.",
    sendOtpFailed: "Failed to send OTP.",
    invalidOtp: "Invalid OTP.",
    forgotPasswordQ: "Forgot password?",
    sendResetLink: "Send reset code",
    haveTokenResetHere: "Have a code already? Reset here",
    ...
    cvLabRequiredForApply: "Use a CV from CV Lab. Upload external CVs in CV Lab and run AI analysis before applying.",
    ...
    analysisStatus: "AI analysis",
    analysisPending: "Analysis in progress",
    analysisSucceeded: "Analysis ready",
    analysisFailed: "Analysis unavailable",
    analysisNotRequested: "No analysis requested",
    analysisRetryStart: "Retry started.",
    analysisRetryFailed: "Could not restart analysis.",
    retryApplicationAnalysis: "Retry analysis",
    analysisSummary: "AI summary",
    analysisErrorHint: "We submitted your application, but the AI analysis could not be completed.",
    analysisCompletedAt: "Analyzed",
    analysisStartedAt: "Started",
    analysisPendingCount: "Analyses in progress",
    analysisFailedCount: "Analyses failed",
    latestAnalysisReady: "Latest analysis ready",
    analysisPendingShort: "AI pending",
    analysisFailedShort: "AI unavailable",
    analysisReadyShort: "AI ready",
    useUploadedCvForApplication: "Upload a different CV for this application",
    uploadedApplicationCv: "Uploaded application CV",
    useCvFromLab: "Use CV from CV Lab",
    uploadDifferentCvHint: "Upload a tailored CV for this role. We will submit now and analyze it in the background.",
    applicationCvOptionalHint: "Leave both empty if this job does not require a CV.",
    ...
    dangerZoneDesc: "Deleting your account is irreversible. Access is blocked immediately and data is permanently removed after 30 days.",
...
const ar: Dict = {
  ...
  sessionLimitReached: "وصلت إلى الحد الأقصى وهو 3 جلسات محادثة.",
  sessionLimitHint: "لا يمكن إنشاء جلسات جديدة. تواصل مع الدعم لإعادة الضبط.",
  messageLimitReached: "هذه الجلسة وصلت إلى 20 رسالة. تم تعطيل الإرسال.",
  messageLimitCounter: "الرسائل المستخدمة",
  market: "السوق",
  ...
  authFailed: "فشل",
  resetLinkSent: "إن وجد البريد، فسيتم إرسال رمز إعادة التعيين.",
  ...
  next: "التالي",
  step: "الخطوة",
  registerStep1Title: "البيانات الأساسية",
  registerStep2Title: "التحقق من رمز البريد",
  registerStep3Title: "إعداد كلمة المرور",
  preferredLanguage: "اللغة المفضلة",
  englishLanguage: "الإنجليزية",
  arabicLanguage: "العربية",
  sendRegistrationOtp: "إرسال رمز التحقق",
  resendRegistrationOtp: "إعادة إرسال الرمز",
  resendIn: "إعادة الإرسال خلال",
  otpCode: "رمز التحقق",
  otpHint: "أدخل رمز التحقق المكون من 6 أرقام المرسل إلى بريدك.",
  verifyOtp: "تأكيد الرمز",
  verified: "تم التحقق",
  otpSentSuccessfully: "تم إرسال رمز التحقق بنجاح.",
  changeEmail: "البريد غير صحيح؟",
  confirmPassword: "تأكيد كلمة المرور",
  passwordsDoNotMatch: "كلمتا المرور غير متطابقتين.",
  emailOtpRequired: "البريد الإلكتروني ورمز التحقق مطلوبان.",
  verifyEmailOtpFirst: "يرجى التحقق من رمز البريد الإلكتروني أولاً.",
  ...
  haveTokenResetHere: "لديك رمز بالفعل؟ أعد التعيين هنا",
  ...
  cvLabRequiredForApply: "استخدم سيرة من مختبر السيرة. أي سيرة خارجية يجب رفعها في مختبر السيرة ثم تشغيل التحليل قبل التقديم.",
  ...
  analysisStatus: "تحليل الذكاء الاصطناعي",
  analysisPending: "التحليل جارٍ",
  analysisSucceeded: "التحليل جاهز",
  analysisFailed: "التحليل غير متاح",
  analysisNotRequested: "لم يُطلب تحليل",
  analysisRetryStart: "تم بدء إعادة التحليل.",
  analysisRetryFailed: "تعذر إعادة تشغيل التحليل.",
  retryApplicationAnalysis: "إعادة التحليل",
  analysisSummary: "ملخص الذكاء الاصطناعي",
  analysisErrorHint: "تم إرسال طلبك، لكن تعذر إكمال تحليل الذكاء الاصطناعي.",
  analysisCompletedAt: "تاريخ التحليل",
  analysisStartedAt: "بدأ في",
  analysisPendingCount: "تحاليل قيد التنفيذ",
  analysisFailedCount: "تحاليل فاشلة",
  latestAnalysisReady: "أحدث تحليل جاهز",
  analysisPendingShort: "الذكاء قيد المعالجة",
  analysisFailedShort: "الذكاء غير متاح",
  analysisReadyShort: "الذكاء جاهز",
  useUploadedCvForApplication: "ارفع سيرة مختلفة لهذا الطلب",
  uploadedApplicationCv: "السيرة المرفوعة لهذا الطلب",
  useCvFromLab: "استخدم سيرة من المختبر",
  uploadDifferentCvHint: "ارفع سيرة مخصصة لهذه الوظيفة. سنرسل الطلب الآن ونحللها في الخلفية.",
  applicationCvOptionalHint: "اترك الخيارين فارغين إذا كانت الوظيفة لا تتطلب سيرة.",
  ...
  dangerZoneDesc: "حذف الحساب إجراء نهائي. سيتم إيقاف الوصول فوراً والحذف النهائي بعد 30 يوماً.",
  ...
  deleteRequestFailed: "تعذر إرسال رمز الحذف.",
  deleteConfirmFailed: "تعذر حذف الحساب.",
  language: "اللغة",
  theme: "السمة",
  themeDark: "داكن",
  themeLight: "فاتح",
