...
const dictionary: Record<Language, Dict> = {
  ...
  ar: {
    ...
    industryRanking: "التصنيف الصناعي",
    ...
    contactSubtitle: "???? ?? ????? ???? ??????.",
    contactFormTitle: "???? ?????",
    contactNote: "أبلغ عن أي مشكلة، أو اقترح ميزات جديدة، أو اطلب تطبيقًا للهاتف أو موقعًا خاصًا بك. نراجع كل رسالة ونرد سريعًا.",
    contactTalentsEmail: "???? ??????",
    contactDevEmail: "???? ??????",
    contactSubject: "???????",
    contactMessage: "???????",
    ...
    scoreHintImprove: "يحتاج لتحسين. ركّز على الكلمات المفتاحية والأثر.",
