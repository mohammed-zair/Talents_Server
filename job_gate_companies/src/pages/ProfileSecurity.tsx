...
const ProfileSecurity: React.FC = () => {
  ...
  const updateProfile = useMutation({
    ...
    onError: () =>
      toast.error(language === "ar" ? "فشل تحديث الملف" : "Failed to update profile"),
  });
  ...
  const copy = {
    ...
    ar: {
      ...
      headerTitle: "مركز العلامة",
      headerSubtitle: "تحكم في هويتك وصلاحياتك وحالة التحقق.",
      verification: "حالة التحقق",
      currentData: "البيانات الحالية",
      verified: "موثق",
      pending: "بانتظار الموافقة",
      dragDrop: "اسحب شعارك هنا أو اضغط للرفع.",
      ...
      strengthHint: "8 أحرف على الأقل مع حرف كبير ورقم",
      changePassword: "تغيير كلمة المرور",
      saving: "جارٍ الحفظ...",
      dangerTitle: "منطقة الخطر",
      dangerDesc:
        "حذف الحساب لا يمكن التراجع عنه. سيتم إيقاف الوصول فوراً والحذف النهائي بعد 30 يوماً.",
      deleteAccount: "حذف الحساب",
      deleteReason: "سبب الحذف (اختياري)",
      deleteOtp: "رمز حذف الحساب",
      sendDeleteOtp: "إرسال الرمز",
      confirmDelete: "تأكيد الحذف",
      deletePasswordRequired: "كلمة المرور الحالية مطلوبة.",
      deleteOtpRequired: "رمز التحقق مطلوب.",
      deleteRequestFailed: "فشل إرسال رمز الحذف.",
      deleteConfirmFailed: "فشل حذف الحساب.",
      cancel: "إلغاء",
    },
  }[language];
  ...
  const strengthLabel =
    language === "ar"
      ? ["ضعيف", "جيد", "قوي"][strengthScore] ?? "ضعيف"
